...
<div class="card-body">
    <div class="card-header">
        <h3 class="card-title">Available positions</h3>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this Position?","delete_user",[$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
	function delete_user($id){
		start_loader();
		$.ajax({
			url:_base_url_+"classes/functions.php?f=deleteposition",
			method:"POST",
			data:{id: $id},
			dataType:"json",			
		})
